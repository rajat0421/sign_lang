...
const Detect = () => {
  ...
  const enableCam = useCallback(() => {
    ...
    if (webcamRunning === true) {
      ...
      // Updated data object without user-related fields
      const data = {
  ...
  }, [webcamRunning, gestureRecognizer, animate, detectedData, dispatch]);
  ...
  useEffect(() => {
    async function loadGestureRecognizer() {
      ...
      const recognizer = await GestureRecognizer.createFromOptions(vision, {
        baseOptions: {
          modelAssetPath:
            "https://ik.imagekit.io/qk07zr4kz/sign_language_recognizer_25-04-2023.task?updatedAt=1734859318054",
        },
        numHands: 2,
